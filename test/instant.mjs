...
describe('Instant', ()=>{
  describe('Structure', ()=>{
    ...
    describe('Instant.prototype', ()=>{
      it('Instant.prototype has getEpochSeconds', ()=>{ assert('getEpochSeconds' in Instant.prototype); });
      it('Instant.prototype has getEpochMilliseconds', ()=>{ assert('getEpochMilliseconds' in Instant.prototype); });
      it('Instant.prototype has getEpochMicroseconds', ()=>{ assert('getEpochMicroseconds' in Instant.prototype); });
      it('Instant.prototype has getEpochNanoseconds', ()=>{ assert('getEpochNanoseconds' in Instant.prototype); });
  ...
  describe('Instant.fromString() works', ()=>{
    ...
    it('1976-11-18T15:23:30.123Z', ()=>{
      equal(Instant.fromString('1976-11-18T15:23:30.123Z').getEpochMilliseconds(), Date.UTC(1976,10,18,15,23,30,123));
    });
    it('1976-11-18T15:23:30.123456Z', ()=>{
      equal(Instant.fromString('1976-11-18T15:23:30.123456Z').getEpochMicroseconds(), BigInt(Date.UTC(1976,10,18,15,23,30,123)) * BigInt(1e3) + BigInt(456));
    });
    it('1976-11-18T15:23:30.123456789Z', ()=>{
      equal(Instant.fromString('1976-11-18T15:23:30.123456789Z').getEpochNanoseconds(), BigInt(Date.UTC(1976,10,18,15,23,30,123)) * BigInt(1e6) + BigInt(456789));
    });
  });
});
