...
const instance = new temporal.CivilDateTime(1976, 11, 18, 15, 23, 30, 450, 12, 345);
...
assert.sameValue(instance.microsecond, 12);
assert.sameValue(instance.nanosecond, 345);
