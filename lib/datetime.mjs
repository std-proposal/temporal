...
export class DateTime {
  ...
  withZone(timeZone, choice = EARLIER) {
    ...
    return Object.create(ZonedDateTime.prototype, { [DATA]: { value: Object.freeze({ instant, dateTime, timeZone }) } });
  }

  difference(other = {}) {
    other = copyProps(this, 'string' === typeof other ? DateTime.fromString(other) : other);
