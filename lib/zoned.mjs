...
export class ZonedDateTime {
  ...
  getTimeZoneName(mode = 'raw') {
    assert.enum(mode, 'raw', 'long', 'short');
    return mode === 'raw' ? this.getTimeZone().name : this.getTimeZone().zoneName(this.getInstant(), mode);
  }
  getTimeZoneOffset() {
    return this.getTimeZone().offset(this.getInstant());
  }
  getDateTime() {
