import { DATA, REGEX, assert, daysInMonth, pad, padYear, copyProps, toDayOfWeek, toDayOfYear, toWeekOfYear } from './shared.mjs';
...
import { balance } from '/code/temporal/temporal/lib/shared.mjs';
